...
#### Significance tests of assumptions {#sec-assumption-sig-tests}
...
6.  Write up the results in a short report.
:::
...
follower_tib |> 
  ggplot2::ggplot(data = _, aes(x = animal_posts, y = n_followers)) + 
