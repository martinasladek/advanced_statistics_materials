...
1.  Choose the name for the function. `d_to_g` is a good and informative choice. Then use `function()` to create it. Inside of `function()`, specify the values you need to supply to perform the operations inside of the function. In our case, this is d and n.
...
We can do the same for variance, where adjust the variance associated with d with using the square of j:
