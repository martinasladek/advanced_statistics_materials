...
model_log_1 <- glm(level_1_vs_levels_23  ~ outcome + ai_chatbot, data = app_tib, family = "binomial")
model_log_2 <- glm(levels_12_vs_level_3  ~ outcome + ai_chatbot, data = app_tib, family = "binomial")
...
-   `ai_chatbot` estimate for Level 1 vs 2&3: 5.48

-   `ai_chatbot` estimate for Level 1&2 vs 3: 3.47

-   `outcomeBooked an appointment` estimate for Level 1 vs 2&3: 7.75

-   `outcomeBooked an appointment` estimate for Level 1&2 vs 3: 1.11
