...
alert_glm |> check_model()
alert_glm |> performance()
alert_glm |> test_wald()
alert_glm |> parameters()

alert_gamma <- glm(response_time ~ modality + signal_complexity + alertness + gpws_time, 
                   family = Gamma(link = "log"),
                   data = alert_tib)

alert_gamma |> check_model()
alert_gamma |> performance()
alert_gamma |> test_wald()
alert_gamma |> parameters()
